...
// truncate("Вот, что мне хотелось бы сказать на эту тему:", 20) = "Вот, 
// что мне хотело…"
...
console.log(truncate("Вот, что мне хотелось бы сказать на эту тему:", 23))
console.log(truncate("привет! как дела? что делать будешь в воскременье?", 19))